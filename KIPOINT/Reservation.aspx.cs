...
namespace KIPOINT
{
    public partial class Reservation : System.Web.UI.Page
    {
        ...
        void load_data()
        {
            MySqlCommand cmd_load = new MySqlCommand("SELECT * FROM view_reservation  WHERE reserved_with = 0", con);
        ...
        protected void OnRowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            string reservation_status = (row.FindControl("reservation_status") as Label).Text;
        ...
        protected void OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    e.Row.Cells[12].Text = "Disapproved";
                ...
                {
                    e.Row.Cells[12].Text = "Cancel";
                    e.Row.Cells[12].BackColor = System.Drawing.Color.Red;
                    e.Row.Cells[12].ForeColor = System.Drawing.Color.White;
                }
                else if (v_status == "Rescheduled")
                {
                    e.Row.Cells[12].Text = "Rescheduled";
                ...
                else
                {
                    if ((DateTime.Today == date_start && DateTime.Today <= date_end) && (v_status == "Approved"))
                    {
                        ...
                        else
                        {
                            if ((now <= start) && (now <= end))
                            {
                                e.Row.Cells[12].Text = "Incoming";
                                e.Row.Cells[12].BackColor = System.Drawing.Color.Yellow;
                                e.Row.Cells[12].ForeColor = System.Drawing.Color.Black;
                            }
                            else
                            {
                                e.Row.Cells[12].Text = "Completed";
                                e.Row.Cells[12].BackColor = System.Drawing.Color.Red;
                                e.Row.Cells[12].ForeColor = System.Drawing.Color.White;
                            }
                        }
