...
namespace KIPOINT
{
    public partial class ReservationViewREQ : System.Web.UI.Page
    {
        ...
        {
            MySqlCommand cmd_edit = new MySqlCommand("UPDATE equipment_reservation SET status=@status , approved_by=@approved_by WHERE id = @id", con);

            var command = cmd_edit.Parameters;
            command.AddWithValue("@status", status);
            command.AddWithValue("@approved_by", Session["id"]);
        ...
        {
            MySqlCommand cmd_edit = new MySqlCommand("UPDATE equipment_reservation SET purpose=@purpose, date_start=@date_start, date_end=@date_end, time_start=@time_start, time_end=@time_end, remarks=@remarks, status=@status, approved_by=@approved_by  WHERE id = @id", con);
        ...
        protected void btn_approve_Click(object sender, EventArgs e)
        {
            ...
            else if (btn_approve.Text == "Submit & Approved")
            {
        ...
        protected void btn_disapprove_Click(object sender, EventArgs e)
        {
            ...
            if (btn_disapprove.Text == "Disapproved")
            {
                UpdateEquipmentStatus("Disapproved");
                Label1.ForeColor = System.Drawing.Color.LimeGreen;
                Label1.Text = "The Reservation has been Disapproved.";
            }
            else
            {
                UpdateEquipmentStatus("Cancel");
                Label1.ForeColor = System.Drawing.Color.LimeGreen;
                Label1.Text = "The Reservation has been Cancel.";
            }
        }
        ...
        protected void btn_reschedule_Click(object sender, EventArgs e)
        {
            ...
            Label1.ForeColor = System.Drawing.Color.LimeGreen;
            Label1.Text = "The Reservation has been rescheduled.";
