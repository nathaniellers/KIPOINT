<%@ Page Title="View Request" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewRequestReservation.aspx.cs" Inherits="KIPOINT.User.Residential.ViewRequestReservation" %>
               ...
               <div class="modal-content">  
                   ...
                   <div class="auto-style7">'
                        <table align="center" class="nav-justified">
                            ...
                            <td class="auto-style1">
                                <asp:TextBox ID="txt_purpose" runat="server" Height="96px" Width="200px" TextMode="MultiLine"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                   ...
                   <div class="modal-footer">
                       ...
                       <asp:Button ID="btn_approve" runat="server" Text="Save" class="btn btn-success" OnClick="btn_approve_Click" />                    
